/* Shadow <stdint.h> for `zig translate-c` when -isystem includes MSVC.
 * MSVC uses integer literals like `0x...ui64` which aro rejects; this file is the
 * portable branch from Zig's lib/compiler/aro/include/stdint.h (0.16.x), vendored
 * so translate-c keeps using Windows SDK / SDL headers elsewhere.
 *
 * Sync occasionally with: $ZIG_STD/lib/compiler/aro/include/stdint.h (#else branch)
 */
#pragma once
